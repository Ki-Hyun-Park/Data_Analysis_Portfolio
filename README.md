...
- Summary
     ...
     <p>(2). 데이터 전처리 <br/>
     - 운동량 분류(High Level: 5km 달리기, Low Level: 달리지않고 20분동안 휴식)
     - 식생활 분류(High Level: 코카잎 500mg 복용, Low Level: 올리브 오일 500mg 복용)
     - 블록(나이) 3 Levels: 16-35, 36-55, 56+ <br/>
     - 블록(성별) 2 Levels: 남자, 여자 </p>

     <p>(3). 데이터 분석 <br/>
     - 2x2 요인설계 블라블라 <br/>
     - ANOVA(혈압 수치 ~ 운동량 x 식생활)
     - ANOVA(혈압 수치 ~ 운동량 x 식생활 + 나이 + 성별)
     - 회기분석 등등 </p>
     
     <p>(4). 데이터 시각화 <br/>
     - ANOVA(혈압 수치 ~ 운동량 x 식생활)을 활용한 잔차 그림
     - ANOVA(혈압 수치 ~ 운동량 x 식생활 + 나이 + 성별)을 활용한 잔차 그림
     - Interaction plot 등등 </p>
