...
- Background
 ...
 <p>UCLA의 15개 전공을 대상으로 졸업까지 소요되는 수업 갯수 및 시간을 EDA에 사용해봤고 “STEM 전공 vs Non-STEM 전공”의 비교분석을 시각화해서 인사이트를 도출했습니다</p>
 
- Summary
     <p>(1). 데이터 수집 <br/>
     - 수집대상 : UCLA (항공우주공학, 간호학, 언어 & 철학, 통계학, 정치학, 미술학, 대기과학 & 해양학, 컴퓨터공학,  )전공 부서 <br/>
     - 수집 출처 : 미국 프로농구 팬들 / 전 Dodgers 데이터 분석가 </p>
