...
- Background
     <p>
     - The Islands(인터넷 가상 세계)에서 섬 주민들의 식생활과 운동량이 혈압 수치에 어떻게 영향을 미치는지 2x2 요인설계 및 블록(나이, 성별)을 사용한 분석 <br/>
     - 작업 인원수: 3명 <br/>
     - 작업 기간: 3주 </p>
...
<img width="460" height="400" src="images/blood_press_1.png">
<img align="right" width="460" height="400" src="images/blood_press_2.png">
