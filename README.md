...
- Summary
     ...
     - Lasso, LDA, Logistic, PCR, Ridge를 통한 모델링 및 결과 예측 (가장 낮은 RMSE + 가장 높은 유사도 = Ridge) </p>
...
- Background
     <p>
     - UCLA의 15개 전공을 대상으로 졸업까지 소요되는 수업 개수 및 시간을 활용한 EDA 및 비교분석(“STEM 전공 vs Non-STEM 전공”) <br/>
     - 작업 인원수: 5명 <br/>
     - 작업 기간: 약 3주 </p>
