...
- Summary
     ...
     - ANOVA(혈압 수치 ~ 운동량 x 식생활 + 나이 + 성별) <br/>
     - (혈압 수치 ~ 운동량 x 식생활)의 다중비교 </p>
     
     <p>(4). 데이터 시각화 <br/>
     - ANOVA(혈압 수치 ~ 운동량 x 식생활)을 활용한 잔차 그림 <br/>
     - ANOVA(혈압 수치 ~ 운동량 x 식생활 + 나이 + 성별)을 활용한 잔차 그림 <br/>
     - (혈압수치 ~ 운동량 x 식생활)의 교호작용도 </p>
